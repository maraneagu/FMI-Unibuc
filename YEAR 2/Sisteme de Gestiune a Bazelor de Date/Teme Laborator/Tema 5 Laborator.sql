...
-- 3).
CREATE OR REPLACE TYPE tip_orase_mng IS TABLE OF VARCHAR2(20);
/
CREATE TABLE excursie_mng(
    cod_excursie    NUMBER(4) NOT NULL PRIMARY KEY,
    denumire        VARCHAR(20),
...
NESTED TABLE orase STORE AS tabel_orase_mng;
...
BEGIN
    -- A
    INSERT INTO excursie_mng
    VALUES(1, 'E1', 'disponibila', tip_orase_mng('Bucuresti'));
    
    INSERT INTO excursie_mng
    VALUES(2, 'E2', 'disponibila', tip_orase_mng('Campina', 'Ploiesti'));
    
    INSERT INTO excursie_mng
    VALUES(3, 'E3', 'anulata', tip_orase_mng('Paris', 'Londra', 'Roma', 'Venetia', 'Berlin'));
    
    INSERT INTO excursie_mng
    VALUES(4, 'E4', 'anulata', tip_orase_mng('Sibiu', 'Brasov', 'Cluj', 'Iasi', 'Braila'));
    
    INSERT INTO excursie_mng
    VALUES(5, 'E5', 'disponibila', tip_orase_mng('Istanbul'));
